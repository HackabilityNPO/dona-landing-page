...
const IndexPage = () => (
  <Layout>
    ...
    <div className="text-center mt-4 mx-2">
      <p>
        ViaggioItalia4Hackability è una campagna di raccolta di donazioni, nata
        su iniziativa di Viaggio Italia e Hackability, per sostenere un progetto
        per l’autonomia, che Hackability sta lanciando su tutta Italia.
      </p>
    </div>
  </Layout>
)
